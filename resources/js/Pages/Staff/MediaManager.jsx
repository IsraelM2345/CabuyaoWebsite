                    ...
                    <div className="flex items-center gap-3 flex-wrap">
                        {filteredMedia.length > 0 && (
                            <button
                                ...
                                className="flex items-center gap-2 px-3 py-2.5 border border-gray-300 dark:border-slate-600 rounded-lg text-sm font-medium text-gray-700 dark:text-slate-300 hover:bg-gray-50 dark:hover:bg-slate-700 transition"
                            >
                                <input
                                    type="checkbox"
                                    checked={
                                ...
                                />
                                {selectedItems.length === filteredMedia.length && filteredMedia.length > 0 ? 'Deselect All' : 'Select All'}
                            </button>
                        )}
                        ...
                        {selectedItems.length > 0 && (
                            <>
                                <button
                                    ...
                                    className="flex items-center gap-2 px-4 py-2.5 bg-gray-600 hover:bg-gray-700 text-white rounded-lg text-sm font-medium transition"
                                >
                                    <X size={16} />
                        ...
                        <div className="px-6 pt-8 pb-6">
                            ...
                            <div className="text-center mb-6">
                                ...
                                <p className="text-sm text-gray-500 dark:text-slate-400">
                                    This will permanently delete {selectedItems.length} selected media item{selectedItems.length !== 1 ? 's' : ''}. This action cannot be undone.
                                </p>
                            </div>
                            <div className="flex items-center gap-3">
                                <button
